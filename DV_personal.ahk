...
+!2:: ; Edit this line with desired keycode https://www.autohotkey.com/docs/KeyList.htm
	...
	{
		ControlSend, msctls_trackbar323, {Right 65}, NVIDIA Control Panel
	}
	lastCMD = 0
    }
Return
...
+!3:: ; Edit this line with desired keycode https://www.autohotkey.com/docs/KeyList.htm
    if (Gcountsub = 0)
    {
        Gcount := 1
	Gcountsub := 1
        ControlSend, msctls_trackbar323, {Left 65}, NVIDIA Control Panel
	lastCMD := 3
    }
    else
    {
...
; 1.70 Gamma
+!4:: ; Edit this line with desired keycode https://www.autohotkey.com/docs/KeyList.htm
    if (Gcountsub = 0)
    {
        Gcountsub := 1
        ControlSend, msctls_trackbar323, {Right 70}, NVIDIA Control Panel 
